...
ALTER TABLE "saving_throw" ADD FOREIGN KEY ("charcter_id_fkey") REFERENCES "question" ("id");

ALTER TABLE "ability" ADD FOREIGN KEY ("charcter_id_fkey") REFERENCES "question" ("id");

ALTER TABLE "skill" ADD FOREIGN KEY ("charcter_id_fkey") REFERENCES "question" ("id");

ALTER TABLE "character_campaign" ADD FOREIGN KEY ("charcter_id_fkey") REFERENCES "question" ("id");

ALTER TABLE "question" ADD FOREIGN KEY ("user_id_fkey") REFERENCES "user" ("id");
...
ALTER TABLE "question" ADD FOREIGN KEY ("class_id_fkey") REFERENCES "ref_class" ("id");
...
ALTER TABLE "question" ADD FOREIGN KEY ("ref_race_if_fkey") REFERENCES "ref_race" ("id");
...
ALTER TABLE "question" ADD FOREIGN KEY ("ref_alignment_id_fkey") REFERENCES "ref_alignment" ("id");
